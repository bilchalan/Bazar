...
exports.registerUser = catchAsyncErrors(async (req, res, next) => {
  ...
  if (user) {
    return next(new errorHandler("This email has been used already. You can login or use another email.", 400));
  }
...
exports.updateProfile = catchAsyncErrors(async (req, res, next) => {
    ...
    if (req.body.avatar !== "") {
      ...
      if(req.body.avatar!=req.body.checkAvatar)
      {
        ...
        newUserData.avatar={public_id:imageId,url:imageUrl}
      }
    }
